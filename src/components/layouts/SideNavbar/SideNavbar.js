          ...
          <li>
            <a href="subscriptions.html">
              <img
                className="img-fluid"
                alt=""
                src="https://askbootstrap.com/preview/vidoe-v1-3/theme-six/img/s1.png"
              />{" "}
              Your Life
            </a>
          </li>
          <li>
            <a href="subscriptions.html">
              <img
                className="img-fluid"
                alt=""
                src="https://askbootstrap.com/preview/vidoe-v1-3/theme-six/img/s2.png"
              />{" "}
              Unboxing <span className="badge badge-warning">2</span>
            </a>
          </li>
          <li>
            <a href="subscriptions.html">
              <img
                className="img-fluid"
                alt=""
                src="https://askbootstrap.com/preview/vidoe-v1-3/theme-six/img/s3.png"
              />{" "}
              Product / Service
            </a>
          </li>
          <li>
            <a href="subscriptions.html">
              <img
                className="img-fluid"
                alt=""
                src="https://askbootstrap.com/preview/vidoe-v1-3/theme-six/img/s4.png"
              />{" "}
              Gaming
            </a>
          </li>
